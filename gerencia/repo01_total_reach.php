...
$db = new TransactionSCI();
  ...
  $usuarios = $db->select_repo_gerencia();

  $spreadsheet = new Spreadsheet();
  $sheet = $spreadsheet->getActiveSheet();
  $sheet->setTitle("Users");
  $sheet->setCellValue("A1", "id_proyecto");
  $sheet->setCellValue("B1", "Proyecto");
  $sheet->setCellValue("C1", "id_tema");
  $sheet->setCellValue("D1", "Tema");
  $sheet->setCellValue("E1", "id_subtema");
  $sheet->setCellValue("F1", "Subtema");
  $sheet->setCellValue("G1", "id_actividad");
  $sheet->setCellValue("H1", "Actividad");
  $sheet->setCellValue("I1", "Región");
  $sheet->setCellValue("J1", "Niñas");
  $sheet->setCellValue("K1", "Niños");
  $sheet->setCellValue("L1", "Otros menores");
  $sheet->setCellValue("M1", "Subtotal menores");
  $sheet->setCellValue("N1", "Mujeres");
  $sheet->setCellValue("O1", "Hombres");
  $sheet->setCellValue("P1", "Otros adultos");
  $sheet->setCellValue("Q1", "Subtotal adultos");
  $i = 2;
  ...
  $fileName = "Reporte_total_reach_" . $timestamp1 . ".xlsx";
