...
<h1 class="display-8">MAESTRO ITEM ES ADULTO</h1> 
<div class="container">
...
<script type="text/javascript">
  ...
  $(document).on('submit', '#addUser', function(e) {
    e.preventDefault();
    var nom_adulto = $('#addnom_adultoField').val();
    if (nom_adulto != '') {
      $.ajax({
        url: "adulto_add.php",
        type: "post",
        data: {
          nom_adulto: nom_adulto
        },
  ...
  $(document).on('submit', '#updateUser', function(e) {
    e.preventDefault();
    var nom_adulto = $('#nom_adultoField').val();
    var trid = $('#trid').val();
    var id = $('#id').val();
    if (nom_adulto != '') {
    $.ajax({
      url: "adulto_update.php",
      type: "post",
      data: {
        nom_adulto: nom_adulto,
        id: id
      ...
      success: function(data) {
        ...
        if (status == 'true') {
          ...
          row.row("[id='" + trid + "']").data([id, nom_adulto, button]);
  ...
  $('#tablaUsuarios').on('click', '.editbtn ', function(event) {
    ...
    var trid = $(this).closest('tr').attr('id');
      ...
      $.ajax({
        ...
        success: function(data) {
          var json = JSON.parse(data);
          $('#nom_adultoField').val(json.nom_adulto);
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="updateUser">
            ...
            <div class="mb-3 row">
              <label for="nom_adultoField" class="col-md-3 form-label">Nombre Item</label>
              <div class="md-form amber-textarea active-amber-textarea col-md-8">
                <input type="text" class="form-control" id="nom_adultoField" name="tipoident" maxlength="50">
              </div>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="addUser" action="">
            <div class="mb-3 row">
              <label for="addnom_adultoField" class="col-md-3 form-label">Item</label>
              <div class="col-md-9">
                <input type="text" class="form-control" id="addnom_adultoField" name="tipoident" maxlength="50">
              </div>
            </div>
            <div class="text-center">
