...
$db = new TransactionSCI();
  ...
  $usuarios = $db->select_repo_gerencia("vista_repo_total_reach_actividades");
  ...
  $sheet->setCellValue("K1", "id_actividad");
  $sheet->setCellValue("L1", "Actividad");
  $sheet->setCellValue("M1", "id_región");
  $sheet->setCellValue("N1", "Región");
  $sheet->setCellValue("O1", "Niñas");
  $sheet->setCellValue("P1", "Niños");
  $sheet->setCellValue("Q1", "Otros menores");
  $sheet->setCellValue("R1", "Subtotal menores");
  $sheet->setCellValue("S1", "Mujeres");
  $sheet->setCellValue("T1", "Hombres");
  $sheet->setCellValue("U1", "Otros adultos");
  $sheet->setCellValue("V1", "Subtotal adultos");
  $i = 2;
  ...
  $fileName = "Reporte_total_reach_actividades_" . $timestamp1 . ".xlsx";
