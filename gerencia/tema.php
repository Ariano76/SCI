...
<h1 class="display-8">MAESTRO ITEM TEMA</h1> 
<div class="container">
...
<script type="text/javascript">
  ...
  $(document).on('submit', '#updateUser', function(e) {
    e.preventDefault();
    var nom_tema = $('#nom_temaField').val();
    var trid = $('#trid').val();
    var id = $('#id').val();
    if (nom_tema != '') {
    $.ajax({
      ...
      success: function(data) {
        ...
        if (status == 'true') {
          ...
          row.row("[id='" + trid + "']").data([id, nom_tema, button]);
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="updateUser">
            ...
            <div class="mb-3 row">
              <label for="nom_temaField" class="col-md-3 form-label">Nombre Item</label>
              <div class="md-form amber-textarea active-amber-textarea col-md-8">
                <input type="text" class="form-control" id="nom_temaField" name="tipoident" maxlength="50">
              </div>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="addUser" action="">
            <div class="mb-3 row">
              <label for="addnom_temaField" class="col-md-3 form-label">Item</label>
              <div class="col-md-9">
                <input type="text" class="form-control" id="addnom_temaField" name="tipoident" maxlength="50">
              </div>
            </div>
            <div class="text-center">
