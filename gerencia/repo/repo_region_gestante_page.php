...
<div class="col-md-12">
  ...
  <div class="card text-dark bg-light">
    <div class="card-header">
      REPORTE TOTAL REACH POR REGIONES - FILTRO
    </div>
    <div class="card-body">
      <form action="repo_region_gestante.php" method="POST" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
        <div class="form-group">
          <label for="txtImagen">En este apartado podremos generar el reporte en formato excel que nos permitirá conocer el número de beneficiarios que han participado en cada una de las diferentes regiones segmentada por las siguientes variables:</label>
          <br>
          <br>          
        </div>
        ...
        <div class="btn-group" role="group" aria-label="Basic example">
          <button type="submit" id="submit" name="import" value="agregar" onclick="return validarFormulario();" class="btn btn-success btn-lg">Generar Reporte Regiones</button>
        </div>
