...
$db = new TransactionSCI();
  ...
  if ($gestante>0) {
    ...
    $usuarios = $db->select_repo_gerencia_gestante("SP_repo_gerencia_tipoproyectos_discapacidad",$discapacidad);
    $retVal = 'Discapacidad' . "_" . $txt2;
  } else {
    $usuarios = $db->select_repo_gerencia_gestante("SP_repo_gerencia_tipoproyectos_nacionalidad",$nacionalidad);
    $retVal = 'Nacionalidad' . "_" . $txt3;
  }
  $name = "Reporte_total_reach_tipoproyectos_".$retVal;
