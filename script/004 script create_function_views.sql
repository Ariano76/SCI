...
BEGIN 
	...
	THEN loop_label: 
		LOOP IF i>CHAR_LENGTH(original) 
		THEN LEAVE loop_label; 
		END IF; SET ch = SUBSTRING(original,i,1); 
IF NOT ch REGEXP pattern 
THEN SET temp = CONCAT(temp,ch); 
ELSE SET temp = CONCAT(temp,replacement); 
END IF; SET i=i+1; 
END LOOP; 
ELSE SET temp = original; 
END IF; 
RETURN temp; 
END;
...
CREATE VIEW `vista_cantidad_ninos` AS
	SELECT b.id_beneficiario, b.region_beneficiario, b.numero_cedula as cedula_beneficiario_principal, i.nombre_1a as nombre, i.genero_1 as genero, i.fecha_nacimiento_1 as fecha_nacimiento, F_AGE(i.fecha_nacimiento_1) as edad, F_MES(i.fecha_nacimiento_1) as meses, i.relacion_1 as relacion	FROM integrantes i inner join encuesta e on i.id_beneficiario = e.id_beneficiario 
	inner join beneficiario b on b.id_beneficiario = e.id_beneficiario 
	...
	union all
	SELECT b.id_beneficiario, b.region_beneficiario, b.numero_cedula as cedula_beneficiario_principal, i.nombre_2a as nombre, i.genero_2 as genero, i.fecha_nacimiento_2 as fecha_nacimiento, F_AGE(i.fecha_nacimiento_2) as edad, F_MES(i.fecha_nacimiento_2) as meses, i.relacion_2 as relacion	FROM integrantes i inner join encuesta e on i.id_beneficiario = e.id_beneficiario 
	inner join beneficiario b on b.id_beneficiario = e.id_beneficiario 
	...
	union all
	SELECT b.id_beneficiario, b.region_beneficiario, b.numero_cedula as cedula_beneficiario_principal, i.nombre_3a as nombre, i.genero_3 as genero, i.fecha_nacimiento_3 as fecha_nacimiento, F_AGE(i.fecha_nacimiento_3) as edad, F_MES(i.fecha_nacimiento_3) as meses, i.relacion_3 as relacion	FROM integrantes i inner join encuesta e on i.id_beneficiario = e.id_beneficiario 
	inner join beneficiario b on b.id_beneficiario = e.id_beneficiario 
	...
	union all
	SELECT b.id_beneficiario, b.region_beneficiario, b.numero_cedula as cedula_beneficiario_principal, i.nombre_4a as nombre, i.genero_4 as genero, i.fecha_nacimiento_4 as fecha_nacimiento, F_AGE(i.fecha_nacimiento_4) as edad, F_MES(i.fecha_nacimiento_4) as meses, i.relacion_4 as relacion	FROM integrantes i inner join encuesta e on i.id_beneficiario = e.id_beneficiario 
	inner join beneficiario b on b.id_beneficiario = e.id_beneficiario 
	...
	union all
	SELECT b.id_beneficiario, b.region_beneficiario, b.numero_cedula as cedula_beneficiario_principal, i.nombre_5a as nombre, i.genero_5 as genero, i.fecha_nacimiento_5 as fecha_nacimiento, F_AGE(i.fecha_nacimiento_5) as edad, F_MES(i.fecha_nacimiento_5) as meses, i.relacion_5 as relacion	FROM integrantes i inner join encuesta e on i.id_beneficiario = e.id_beneficiario 
	inner join beneficiario b on b.id_beneficiario = e.id_beneficiario 
	...
	union all
	SELECT b.id_beneficiario, b.region_beneficiario, b.numero_cedula as cedula_beneficiario_principal, i.nombre_7a as nombre, i.genero_7 as genero, i.fecha_nacimiento_7 as fecha_nacimiento, F_AGE(i.fecha_nacimiento_7) as edad, F_MES(i.fecha_nacimiento_7) as meses, i.relacion_7 as relacion	FROM integrantes i inner join encuesta e on i.id_beneficiario = e.id_beneficiario 
	inner join beneficiario b on b.id_beneficiario = e.id_beneficiario 
