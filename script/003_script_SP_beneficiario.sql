...
/*******************************************/
/* REPORTES REGISTROS UNICOS PARA GERENCIA */
/*******************************************/

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_actividades`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_actividades`()
BEGIN
	SELECT * FROM vista_repo_total_reach_actividades;
END |
DELIMITER ;

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_subtemas`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_subtemas`()
BEGIN
DROP TABLE IF EXISTS totalreach_subtemas ;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_subtemas AS 
(
...
DROP PROCEDURE IF EXISTS `SP_repo_gerencia_temas`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_temas`()
BEGIN
DROP TABLE IF EXISTS totalreach_temas ;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_temas AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_tipo_proyecto, tp.nom_tipo_proyecto, p.id_proyecto, p.nom_proyecto, t.id_tema, t.nom_tema, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN proyecto p on rp.id_proyecto = p.id_proyecto
 INNER JOIN tema t on rp.id_tema = t.id_tema
 INNER JOIN tipo_proyecto tp on rp.id_tipo_proyecto = tp.id_tipo_proyecto
 INNER JOIN region r on rp.id_region = r.id_region
);
SELECT anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_proyecto, nom_proyecto as Proyecto, id_tema, nom_tema as Tema, id_region as Región, nom_region, 
COUNT(IF(id_adulto = 2 and id_genero = 1 , 1, NULL)) AS 'Niñas',
COUNT(IF(id_adulto = 2 and id_genero = 2 , 1, NULL)) AS 'Niños',
COUNT(IF(id_adulto = 2 and id_genero = 3 , 1, NULL)) AS 'Otros menores',
COUNT(IF(id_adulto = 2 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal menores',
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_temas
group by anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_proyecto, nom_proyecto, id_tema, nom_tema, id_region, nom_region;
END |
DELIMITER ;

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_proyectos`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_proyectos`()
BEGIN
DROP TABLE IF EXISTS totalreach_proyectos ;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_proyectos AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_tipo_proyecto, tp.nom_tipo_proyecto, p.id_proyecto, p.nom_proyecto, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN proyecto p on rp.id_proyecto = p.id_proyecto
 INNER JOIN tipo_proyecto tp on rp.id_tipo_proyecto = tp.id_tipo_proyecto
 INNER JOIN region r on rp.id_region = r.id_region
);
SELECT anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_proyecto, nom_proyecto as Proyecto, id_region as Región, nom_region, 
COUNT(IF(id_adulto = 2 and id_genero = 1 , 1, NULL)) AS 'Niñas',
COUNT(IF(id_adulto = 2 and id_genero = 2 , 1, NULL)) AS 'Niños',
COUNT(IF(id_adulto = 2 and id_genero = 3 , 1, NULL)) AS 'Otros menores',
COUNT(IF(id_adulto = 2 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal menores',
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_proyectos
group by anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_proyecto, nom_proyecto, id_region, nom_region;
END |
DELIMITER ;

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_tipoproyectos`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_tipoproyectos`()
BEGIN
DROP TABLE IF EXISTS totalreach_tipoproyectos ;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_tipoproyectos AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_tipo_proyecto, tp.nom_tipo_proyecto, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN tipo_proyecto tp on rp.id_tipo_proyecto = tp.id_tipo_proyecto
 INNER JOIN region r on rp.id_region = r.id_region
);
SELECT anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_region as Región, nom_region, 
COUNT(IF(id_adulto = 2 and id_genero = 1 , 1, NULL)) AS 'Niñas',
COUNT(IF(id_adulto = 2 and id_genero = 2 , 1, NULL)) AS 'Niños',
COUNT(IF(id_adulto = 2 and id_genero = 3 , 1, NULL)) AS 'Otros menores',
COUNT(IF(id_adulto = 2 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal menores',
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_tipoproyectos
group by anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_region, nom_region;
END |
DELIMITER ;

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_regiontrimestre`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_regiontrimestre`()
BEGIN
DROP TABLE IF EXISTS totalreach_regiontrimestre ;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_regiontrimestre AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN region r on rp.id_region = r.id_region
);
SELECT anio_actividad, trimestre_actividad, id_region as Región, nom_region, 
COUNT(IF(id_adulto = 2 and id_genero = 1 , 1, NULL)) AS 'Niñas',
COUNT(IF(id_adulto = 2 and id_genero = 2 , 1, NULL)) AS 'Niños',
COUNT(IF(id_adulto = 2 and id_genero = 3 , 1, NULL)) AS 'Otros menores',
COUNT(IF(id_adulto = 2 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal menores',
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_regiontrimestre
group by anio_actividad, trimestre_actividad, id_region, nom_region;
END |
DELIMITER ;

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_region`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_region`()
BEGIN
DROP TABLE IF EXISTS totalreach_region ;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_region AS 
(
SELECT DISTINCT rp.anio_actividad, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN region r on rp.id_region = r.id_region
);
SELECT anio_actividad, id_region as Región, nom_region, 
COUNT(IF(id_adulto = 2 and id_genero = 1 , 1, NULL)) AS 'Niñas',
COUNT(IF(id_adulto = 2 and id_genero = 2 , 1, NULL)) AS 'Niños',
COUNT(IF(id_adulto = 2 and id_genero = 3 , 1, NULL)) AS 'Otros menores',
COUNT(IF(id_adulto = 2 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal menores',
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_region
group by anio_actividad, id_region, nom_region;
END |
DELIMITER ;

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_total`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_total`()
BEGIN
DROP TABLE IF EXISTS totalreach_total ;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_total AS 
(
SELECT DISTINCT rp.anio_actividad, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
);
...
/****************************************************************/
/* REPORTES REGISTROS UNICOS PARA GERENCIA - VARIABLE GESTANTE  */
/****************************************************************/
...
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_temas_gestante`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_temas_gestante ;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_temas_gestante AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_tipo_proyecto, tp.nom_tipo_proyecto, p.id_proyecto, p.nom_proyecto, t.id_tema, t.nom_tema, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN proyecto p on rp.id_proyecto = p.id_proyecto
 INNER JOIN tema t on rp.id_tema = t.id_tema
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_temas_gestante
group by anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_proyecto, nom_proyecto, id_tema, nom_tema, id_region, nom_region;
END |
DELIMITER ;

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_proyectos_gestante`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_proyectos_gestante`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_proyectos_gestante ;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_proyectos_gestante AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_tipo_proyecto, tp.nom_tipo_proyecto, p.id_proyecto, p.nom_proyecto, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN proyecto p on rp.id_proyecto = p.id_proyecto
 INNER JOIN tipo_proyecto tp on rp.id_tipo_proyecto = tp.id_tipo_proyecto
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_proyectos_gestante
group by anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_proyecto, nom_proyecto, id_region, nom_region;
END |
DELIMITER ;


DROP PROCEDURE IF EXISTS `SP_repo_gerencia_tipoproyectos_gestante`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_tipoproyectos_gestante`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_tipoproyectos_gestante ;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_tipoproyectos_gestante AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_tipo_proyecto, tp.nom_tipo_proyecto, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN tipo_proyecto tp on rp.id_tipo_proyecto = tp.id_tipo_proyecto
 INNER JOIN region r on rp.id_region = r.id_region
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_tipoproyectos_gestante
group by anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_region, nom_region;
END |
DELIMITER ;


DROP PROCEDURE IF EXISTS `SP_repo_gerencia_regiontrimestre_gestante`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_regiontrimestre_gestante`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_regiontrimestre_gestante ;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_regiontrimestre_gestante AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN region r on rp.id_region = r.id_region
 WHERE id_gestante = valor
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_regiontrimestre_gestante
group by anio_actividad, trimestre_actividad, id_region, nom_region;
END |
DELIMITER ;


DROP PROCEDURE IF EXISTS `SP_repo_gerencia_region_gestante`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_region_gestante`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_region_gestante ;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_region_gestante AS 
(
SELECT DISTINCT rp.anio_actividad, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN region r on rp.id_region = r.id_region
 WHERE id_gestante = valor
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_region_gestante
group by anio_actividad, id_region, nom_region;
END |
DELIMITER ;
...
DELIMITER |
CREATE PROCEDURE `SP_list_discapacidad`()
BEGIN
    select id_discapacidad, nom_discapacidad from discapacidad order by id_discapacidad;
END |
DELIMITER ;
...
DROP PROCEDURE IF EXISTS `SP_repo_gerencia_temas_discapacidad`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_temas_discapacidad`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_temas_discapacidad;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_temas_discapacidad AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_tipo_proyecto, tp.nom_tipo_proyecto, p.id_proyecto, p.nom_proyecto, t.id_tema, t.nom_tema, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN proyecto p on rp.id_proyecto = p.id_proyecto
 INNER JOIN tema t on rp.id_tema = t.id_tema
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_temas_discapacidad
group by anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_proyecto, nom_proyecto, id_tema, nom_tema, id_region, nom_region;
END |
DELIMITER ;

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_temas_nacionalidad`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_temas_nacionalidad`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_temas_nacionalidad;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_temas_nacionalidad AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_tipo_proyecto, tp.nom_tipo_proyecto, p.id_proyecto, p.nom_proyecto, t.id_tema, t.nom_tema, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN proyecto p on rp.id_proyecto = p.id_proyecto
 INNER JOIN tema t on rp.id_tema = t.id_tema
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_temas_nacionalidad 
group by anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_proyecto, nom_proyecto, id_tema, nom_tema, id_region, nom_region;
END |
DELIMITER ;

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_proyectos_discapacidad`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_proyectos_discapacidad`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_proyectos_discapacidad;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_proyectos_discapacidad AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_tipo_proyecto, tp.nom_tipo_proyecto, p.id_proyecto, p.nom_proyecto, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN proyecto p on rp.id_proyecto = p.id_proyecto
 INNER JOIN tipo_proyecto tp on rp.id_tipo_proyecto = tp.id_tipo_proyecto
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_proyectos_discapacidad
group by anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_proyecto, nom_proyecto, id_region, nom_region;
END |
DELIMITER ;

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_proyectos_nacionalidad`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_proyectos_nacionalidad`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_proyectos_nacionalidad;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_proyectos_nacionalidad AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_tipo_proyecto, tp.nom_tipo_proyecto, p.id_proyecto, p.nom_proyecto, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN proyecto p on rp.id_proyecto = p.id_proyecto
 INNER JOIN tipo_proyecto tp on rp.id_tipo_proyecto = tp.id_tipo_proyecto
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_proyectos_nacionalidad
group by anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_proyecto, nom_proyecto, id_region, nom_region;
END |
DELIMITER ;

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_tipoproyectos_discapacidad`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_tipoproyectos_discapacidad`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_tipoproyectos_discapacidad;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_tipoproyectos_discapacidad AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_tipo_proyecto, tp.nom_tipo_proyecto, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN tipo_proyecto tp on rp.id_tipo_proyecto = tp.id_tipo_proyecto
 INNER JOIN region r on rp.id_region = r.id_region
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_tipoproyectos_discapacidad
group by anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_region, nom_region;
END |
DELIMITER ;

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_tipoproyectos_nacionalidad`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_tipoproyectos_nacionalidad`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_tipoproyectos_nacionalidad;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_tipoproyectos_nacionalidad AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_tipo_proyecto, tp.nom_tipo_proyecto, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN tipo_proyecto tp on rp.id_tipo_proyecto = tp.id_tipo_proyecto
 INNER JOIN region r on rp.id_region = r.id_region
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_tipoproyectos_nacionalidad
group by anio_actividad, trimestre_actividad, id_tipo_proyecto, nom_tipo_proyecto, id_region, nom_region;
END |
DELIMITER ;


DROP PROCEDURE IF EXISTS `SP_repo_gerencia_regiontrimestre_discapacidad`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_regiontrimestre_discapacidad`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_regiontrimestre_discapacidad;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_regiontrimestre_discapacidad AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN region r on rp.id_region = r.id_region
 WHERE rp.id_discapacidad = valor
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_regiontrimestre_discapacidad
group by anio_actividad, trimestre_actividad, id_region, nom_region;
END |
DELIMITER ;

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_regiontrimestre_nacionalidad`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_regiontrimestre_nacionalidad`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_regiontrimestre_nacionalidad;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_regiontrimestre_nacionalidad AS 
(
SELECT DISTINCT rp.anio_actividad, rp.trimestre_actividad, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN region r on rp.id_region = r.id_region
 WHERE rp.id_nacionalidad = valor
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_regiontrimestre_nacionalidad
group by anio_actividad, trimestre_actividad, id_region, nom_region;
END |
DELIMITER ;


DROP PROCEDURE IF EXISTS `SP_repo_gerencia_region_discapacidad`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_region_discapacidad`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_region_discapacidad;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_region_discapacidad AS 
(
SELECT DISTINCT rp.anio_actividad, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN region r on rp.id_region = r.id_region
 WHERE rp.id_discapacidad = valor
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_region_discapacidad
group by anio_actividad, id_region, nom_region;
END |
DELIMITER ;

DROP PROCEDURE IF EXISTS `SP_repo_gerencia_region_nacionalidad`;
DELIMITER |
CREATE PROCEDURE `SP_repo_gerencia_region_nacionalidad`(in valor int)
BEGIN
DROP TABLE IF EXISTS totalreach_region_nacionalidad;
CREATE TEMPORARY TABLE IF NOT EXISTS totalreach_region_nacionalidad AS 
(
SELECT DISTINCT rp.anio_actividad, rp.id_region, r.nom_region, rp.id_adulto, rp.id_genero, CONCAT(rp.nombre_1,' ',rp.nombre_2,' ',rp.apellido_1,' ',rp.apellido_2) as beneficiario FROM resultado_proyectos rp 
 INNER JOIN region r on rp.id_region = r.id_region
 WHERE rp.id_nacionalidad = valor
...
COUNT(IF(id_adulto = 1 and id_genero = 3 , 1, NULL)) AS 'Otros adultos',
COUNT(IF(id_adulto = 1 and (id_genero = 3 or id_genero = 2 or id_genero = 1), 1, NULL)) AS 'Subtotal adultos'
FROM totalreach_region_nacionalidad
group by anio_actividad, id_region, nom_region;
END |
DELIMITER ;
