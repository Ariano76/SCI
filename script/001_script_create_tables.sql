...
insert into roles(nombre_rol) values('Gerencia');
insert into roles(nombre_rol) values('Coordinador Finanzas');
insert into roles(nombre_rol) values('Analista Finanzas');
...
call SP_Usuario_Insert('Gerencia', 'gerencia@gmail.com', '123456', 3, 1, @total);
