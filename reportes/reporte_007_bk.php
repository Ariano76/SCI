    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-md-3" aria-label="Basic example">
          <button class="btn btn-success btn-lg" onclick="CargarDatosGraficoBarParametro('SP_reporte_07_miembros_en_familia')">Graficar</button>
        </div>
        <div class="col-md-3" aria-label="Basic example">
          <button class="btn btn-success btn-lg" onclick="CargarDatosTabla('SP_reporte_07_miembros_en_familia_00')">Datos en Tabla</button>
        </div>                
      </div>
      <br>
      <div class="row">
      ...
      <div class="row">
        <div class="col-md-3">&nbsp;</div>
        <div class="col-md-6" id="myDataTable">
        <div class="col-md-3">&nbsp;</div>
        </div>        
      </div>                  
      <!--/form-->
